...
\begin{abstract}
  ...
  These groupoid charts and their analogues for the symplectic double and blow-up groupoids are glued by lifting the cluster mutations to groupoid comorphisms whose formulae are motivated by the Hamiltonian perspective of cluster mutations introduced by Fock and Goncharov.
\end{abstract}
\maketitle
...
\end{remark}
As promised, the $\bfc$-vectors, $\bfg$-vectors, and $F$-polynomials completely control the iterated mutations via the following \emph{separation of additions} formulae.
\begin{theorem}
  \label{th:separation}
...
We will need the following important consequence of the separation of additions formulae and the sign-coherence of $\bfc$-vectors.
\begin{corollary}
...
To establish this, we introduce analogues of the separation of additions formulae from Theorem~\ref{th:separation}.

As a first step in lifting the separation of additions formulae~\eqref{eq:separation of additions 1} and~\eqref{eq:separation of additions 2} to the level of groupoids we introduce analogues of the $\bfc$-vectors and $\bfg$-vectors which describe iterations of the cluster mutations.
...
\begin{proof}
  ...
  The result then immediately follows from Lemma~\ref{le:dual vectors} part (3) together with the separation of additions formulae in Theorem~\ref{th:groupoid separation of additions}.
\end{proof}
