...
Our main interest will be with Lie groupoids having the following additional structure.
\begin{definition}
...
\begin{theorem} 
  ...
  \begin{enumerate}
    ...
    \item the target map is $\beta: T^*L \to L, \quad (\bfp, \bfx) \mapsto \bfa \circ \bfx$, where $a_i = e^{\sum_j \Omega_{ij} x_jp_j}$;
	...
	\omega = \sum_{i} dx_i \wedge dp_i
	  + \left(
	    \sum_{i, j} \Omega_{ij}x_i p_j d x_i \wedge d p_j 
...
\begin{theorem} 
  ...
  \begin{enumerate}
    ...
    \item the symplectic form $\omega$ is
      \begin{equation} 
        \label{eq:2-formG_X}
	\omega = \sum_{i} \frac{d x_i}{x_i} \wedge \frac{d s_i}{s_i} + \sum_{j < i} \Omega_{ij} \frac{d s_i}{s_i} \wedge \frac{d s_j}{s_j}.
      \end{equation}
  \end{enumerate}
\end{theorem}
...
\begin{lemma}
  ...
  \begin{align}
    ...
    \pi_{\cG_\cA}:=\omega_{\cG_\cA}^{-1}&=\sum_{i} \frac{\partial}{\partial p_i} \wedge \frac{\partial}{\partial x_i} - \sum_{i, j} \Omega_{ij}x_i p_j \frac{\partial}{\partial x_i} \wedge \frac{\partial}{\partial p_j}\\
...
\begin{proof}
  ...
  \begin{align*}
    \pi_{\cG_\cA}^\flat: &~ dx_i \mapsto -\frac{\partial}{\partial p_i} - \sum_{j} \Omega_{ij}x_j p_i \frac{\partial}{\partial p_j}+ \sum_{j} \Omega_{ij}x_ix_j \frac{\partial}{\partial x_j}, \\
  ...
  \begin{align*}
    \omega_{\cG_\cA}^\sharp: &~ \frac{\partial}{\partial x_i} \mapsto dp_i + \sum_{j} \Omega_{ij}x_i p_j d p_j + \sum_{j} \Omega_{ij}p_ip_j d x_j, \\
    &~ \frac{\partial}{\partial p_i} \mapsto - dx_i + \sum_{j} \Omega_{ij}p_i x_j d x_j + \sum_{j} \Omega_{ij}x_ix_j d p_j.
  \end{align*}
...
\begin{align*}
  ...
  \tilde H_\cA^{k,\varepsilon}&=\frac{\varepsilon}{d_k}\Li_2(-\hat y_k^\varepsilon)-\frac{\varepsilon}{d_k}\Li_2\left(-\hat y_k^\varepsilon e^{d_kp_kx_k}\right);\\
...
\begin{lemma}
  ...
  \begin{align}
    \dot q_\ell&=\{\tilde H_\cX^{k,\varepsilon},q_\ell\}_{\cG_\cX}=\frac{\delta_{k\ell}}{d_ky_k}\log\left(\frac{1+y_k^\varepsilon e^{\varepsilon\sum_{\ell'} d_k B_{k\ell'}q_{\ell'} y_{\ell'}}}{1+y_k^\varepsilon}\right)+B_{k\ell}\log(1+y_k^\varepsilon)q_\ell;\\
    \dot t_\ell&=\{\bar H_\cX^{k,\varepsilon},t_\ell\}_{\cD_\cX}=\frac{\delta_{k\ell}}{d_k}\log\left(\frac{1+y_k^\varepsilon \prod_{\ell'}t_{\ell'}^{\varepsilon d_k B_{k\ell'}}}{1+y_k^\varepsilon}\right)t_k;\\
...
\begin{corollary}
  For $1\le k\le n$ and $\varepsilon\in\{\pm1\}$, we have
  \begin{align*}
    (\tilde\varphi_\cX^1)^*(q_\ell y_\ell)&=q_\ell y_\ell+\frac{\delta_{k\ell}}{d_k}\log\left(\frac{1+y_k^\varepsilon e^{\varepsilon\sum_{\ell'} d_k B_{k\ell'}q_{\ell'} y_{\ell'}}}{1+y_k^\varepsilon}\right);\\
    (\bar\varphi_\cX^1)^*(t_\ell)&=\left(\frac{1+y_k^\varepsilon \prod_{\ell'}t_{\ell'}^{\varepsilon d_k B_{k\ell'}}}{1+y_k^\varepsilon}\right)^{\delta_{k\ell}/d_k}t_\ell;\\
