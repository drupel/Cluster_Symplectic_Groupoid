...
It immediately follows that $y_k$ is a conserved quantity under the flow of $L_\cX$ by the vector field $X_\cX^{k,\varepsilon}$.
Since the map $\rho$ is Poisson with $\hat y_k=\rho^*(y_k)$, we also see that $\hat y_k$ is a conserved quantity under the flow of $L_\cA$ by the vector field $X_\cA^{k,\varepsilon}$.
\begin{corollary}
...
Thus, associated to each $t\in \TT_n$, we obtain a Poisson space $L_{\cX,\bfr;t}$ isomorphic to either $\RR_+^n$ or $(\CC^\times)^n$ and a Poisson space $L_{\cA,\bfr;t}$ isomorphic to either $\RR_+^m$ or $(\CC^\times)^m$.
...
\end{equation}
As above, we also introduce the Poisson spaces $L_{\cX,\bfr;t}$ isomorphic to either $\RR_+^n\times\prod_{k=1}^n \RR^{r_k-1}$ or $(\CC^\times)^n\times\prod_{k=1}^n \CC^{r_k-1}$ and $L_{\cA,\bfr;t}$ isomorphic to either $\RR_+^m\times\prod_{k=1}^n \RR^{r_k-1}$ or $(\CC^\times)^m\times\prod_{k=1}^n \CC^{r_k-1}$.
