...
\]
\begin{corollary}
  For $1\le k\le n$ and $\varepsilon\in\{\pm1\}$, the Poisson autmorphism $\varphi_\cX^t: L_\cX \to L_\cX$ in Corollary~\ref{cor:time-one flows} is lifted to the symplectic groupoid automorphisms $\tilde\varphi_\cX^t: \cG_\cX \to \cG_\cX$ and $\bar\varphi_\cX^t: \cD_\cX \to \cD_\cX$, which on coordinates are given by
  \begin{align*}
  ...
  \end{align*}
  and the Poisson autmorphism $\varphi_\cA^t: L_\cX \to L_\cX$ Corollary~\ref{cor:time-one flows} is lifted  to the symplectic groupoid automorphisms $\tilde\varphi_\cA^t: \cG_\cA \to \cG_\cA$ and $\bar\varphi_\cA^t: \cD_\cA \to \cD_\cA$, which on coordinates are given by
  \begin{align*}
