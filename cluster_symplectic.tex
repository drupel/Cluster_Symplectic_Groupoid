...
If $(\cG_1, \omega_1) \to (M_1, \pi_1)$ is the source-simply-connected symplectic groupoid of $(M_1, \pi_1)$ and $(\cG_2, \omega_2) \to (M_2, \pi_2)$ is any symplectic groupoid of $(M_2, \pi_2)$, then a Poisson map $\varphi: (M_1, \pi_1) \to (M_2, \pi_2)$ lifts to a symplectic groupoid map $\tilde{\varphi}: (\cG_1, \omega_1) \rra (\cG_2, \omega_2)$. The map $\tilde{\varphi}$ is surjective if $\varphi$ is surjective and $\cG_2$ is source-connected. However in general Poisson maps do necessarily lift to symplectic groupoid maps. This will be a recurring theme when we lift to cluster mutations to groupoid mutations.
