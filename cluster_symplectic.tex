...
\begin{abstract}
  ...
  These charts and their analogues for the symplectic double and blow-up groupoids are glued by groupoid comorphisms lifting the cluster mutations whose formulae are motivated by the Hamiltonian perspective of cluster mutations introduced by Fock and Goncharov.
\end{abstract}
\maketitle
