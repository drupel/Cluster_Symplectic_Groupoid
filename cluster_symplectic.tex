...
\begin{lemma}
  ...
  \begin{align}
    ...
    \label{eq:s dot}\dot s_j&=\{\bar H_\cA^{k,\varepsilon},s_j\}_{\cD_\cA}=
  \end{align}
\end{lemma}
\begin{proof}
  We prove equations \eqref{eq:p dot} and \eqref{eq:s dot}, leaving the others as an exercise for the reader.
