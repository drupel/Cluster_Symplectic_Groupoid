...
\begin{align*}
	...
	&~ dp_i \mapsto -\frac{\partial}{\partial x_i} - \sum_{j} \Omega_{ij}p_j x_i \frac{\partial}{\partial x_j}- \sum_{j} \Omega_{ij}p_ip_j \frac{\partial}{\partial p_j},
\end{align*}
and for the symplectic structure $\omega_{\cG_\cA}$ as in \eqref{eq:2-formG_A}, the bundle map ${\omega_{\cG_\cA}}^\sharp: T^*\cG_\cA \to T\cG_\cA, \quad \alpha \mapsto \pi_{\cG_\cA}(\alpha, \cdot)$ is given by
\begin{align*}
