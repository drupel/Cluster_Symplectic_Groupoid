...
\begin{theorem}
  ...
  \end{align}
  where $z^\circ_{\ell,j;t_0}=z_{\ell,j;t_0}$ if the mutation sequence from $t_0$ to $t$ has an even number of mutations in direction $\ell$ and $z^\circ_{\ell,j;t_0}=z_{\ell,r_\ell-j;t_0}$ if this mutation sequence has an odd number of mutations in direction $\ell$.
\end{theorem}
\begin{remark}
