...
\end{proof}
\begin{remark}
  While the formulas for the flows above were defined when $L^+_\cX\cong\RR_+^n$ and $L^+_\cA\cong\RR_+^m$, the formulas for the time-one flows on $\cG_\cX$ and $\cG_\cA$ can be applied equally well in the settings $L^+_\cX\cong(\CC^\times)^n$ and $L^+_\cA\cong(\CC^\times)^m$.
