...
Choosing the standard frames: $\{dx_i, dp_i\}$ for $T^*\cG_\cA$ and $\{\frac{\partial}{\partial x_i}, \frac{\partial}{\partial p_i}\}$ for $T\cG_\cA$, the bundle map ${\pi_{\cG_\cA}}^\flat: T^*\cG_\cA \to T\cG_\cA, \quad \alpha \mapsto \pi_{\cG_\cA}(\alpha, \cdot)$ is given by
\begin{align*}
...
\end{align*}
We will leave it to the reader to check that ${\pi_{\cG_\cA}}^\flat$ and ${\omega_{\cG_\cA}}^\sharp$ are inverse to each other.
\end{proof}
