...
\begin{lemma}
  ...
  \begin{equation*}
    \dot b_{\ell,j}=\{H_{-,\bfr}^{k,\varepsilon},b_{\ell,j}\}_-=\delta_{k\ell}\frac{\varepsilon}{d_k}\int_*^* \frac{u^{j-1}}{Z_k(u)}du,
  \end{equation*}
...
\begin{lemma}
  ...
  These fix the coordinate functions $b_{\ell,j}$ on $T^*L^\times_\bfr$ and are given on the remaining fiber coordinates by
  \begin{align}
    \nonumber
