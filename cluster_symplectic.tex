...
In each cluster chart, the symplectic double \cite{MR2470108} is a source-connected symplectic groupoid of the log-canonical Poisson structure.
We give the explicit covering map from the source-simply-connected sympletic groupoid to the symplectic double.

To introduce the notions of symplectic groupoids and Poisson sprays, we switch to Poisson bi-vectors which are equivalent to the Poisson brackets.
\begin{definition}
