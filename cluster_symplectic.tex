...
In this section we study mutations of cluster seeds from the Hamiltonian viewpoint.
This perspective was introduced in \cite{MR2470108} and is the foundation for the main results of \cite{MR3691969}.

The \emph{Euler dilogarithm} is the function of one variable defined by
\[Li_2(z)=\sum\limits_{n=1}^\infty\frac{z^n}{n^2}=-\int_0^z \frac{\log(1-y)}{y}dy.\]
