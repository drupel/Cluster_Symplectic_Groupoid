...
\end{proposition}
\begin{proof}
Recall that the identity map of a Poisson manifold lifts to the identity map of its source-simply-connected symplectic groupoid (c.f.\ \ref{prop:gpd identity}) so parts (1) and (4) immediately follow.
For parts (2), (3), (5) and (6)
