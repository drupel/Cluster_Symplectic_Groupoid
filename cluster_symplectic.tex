...
\begin{align}
  ...
  \big(\mu_{\cX,\bfr}^{t,t_0}\big)^*(y_{k;t})&=\prod_{\ell=1}^n y_{\ell;t_0}^{C_{\ell k;t}} F_{\ell,\bfr;t}(y_{1;t_0},\ldots,y_{n;t_0})^{B_{\ell k;t}};\\
...
\begin{align}
  ...
  \label{eq:GAcomorphism}
\end{align}
Notice that $x_j, \> j \ne k$ and $\hat{y}_k$ are invariant under $\varphi_{\cA,\bfr}$ and $(\varphi_{\cA,\bfr})^*(x_k) = \frac{x_k}{Z_k(\hat{y}_k^\varepsilon)}$. If we apply $\varphi_{\cA,\bfr}$ to the right hand side of \eqref{eq:GAcomorphism}, then $(\varphi_{\cA,\bfr})^*$ is the transpose of $\Lie \left(\varphi_{\cA,\bfr} \right)$.
...
>>>>>>> c6e4d7354df971bff88bd4bec4eede8e91d3b044
