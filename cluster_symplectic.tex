...
\end{equation*}
We extend the star-involution on $L_\bfr$ to $T^*L_\bfr$ via $a_{\ell,j}\mapsto a^*_{\ell,j}:=a_{\ell,r_\ell-j}$.
...
\begin{theorem}
  ...
  \begin{align*}
    ...
    &=\begin{cases}
      a^*_{k,j}+\frac{\varepsilon}{d_k}\int_{y_k^\varepsilon}^{\beta^*(y_k^\varepsilon)} \frac{u^{\varepsilon (r_k-j)-1}}{Z_k(u^\varepsilon)}du & \text{if $\ell=k$;}\\
      a_{\ell,j} & \text{if $\ell\ne k$;}
    \end{cases}\\
    (\mu_{\cA,\bfr}^{k,\varepsilon})^*(a'_{\ell,j})
    &=\begin{cases}
      a^*_{k,j}+\frac{\varepsilon}{d_k}\int_{\hat y_k^\varepsilon}^{\beta^*(\hat y_k^\varepsilon)} \frac{u^{\varepsilon (r_k-j)-1}}{Z_k(u^\varepsilon)}du & \text{if $\ell=k$;}\\
      a_{\ell,j} & \text{if $\ell\ne k$;}
    \end{cases}
  \end{align*}
  ...
  \begin{enumerate}
    ...
    \item Finally, the mutations $\mu_{\cA,\bfr}^{k,\varepsilon}$ appear to be undefined on $p'_j$ and $u'_j$ for $j\ne k$ when $x_j=0$.
      ...
      \begin{align*}
        ...
        &=p_j+\lim_{x_j \to 0}\frac{[-\varepsilon B_{jk} r_k]_+ p_k x_k - \frac{B_{jk}}{d_k}\log\left(\frac{Z^\circ_k(\hat y_k^\varepsilon e^{-\varepsilon d_kp_kx_k})}{Z^\circ_k(\hat y_k^\varepsilon)}\right)}{x_j}\\
        &=p_j-\frac{\varepsilon B_{jk}^2}{d_k} \lim_{x_j\to 0} \frac{ \hat y_k^\varepsilon e^{-\varepsilon d_kp_kx_k} (Z^\circ_k)'(\hat y_k^\varepsilon e^{-\varepsilon d_kp_kx_k}) Z^\circ_k(\hat y_k^\varepsilon) - \hat y_k^\varepsilon Z^\circ_k(\hat y_k^\varepsilon e^{-\varepsilon d_kp_kx_k}) (Z^\circ_k)'(\hat y_k^\varepsilon) }{ x_j Z^\circ_k(\hat y_k^\varepsilon e^{-\varepsilon d_kp_kx_k}) Z^\circ_k(\hat y_k^\varepsilon) }\\
        &=\begin{cases} 
          p_j & \text{if $|B_{jk}| \ne 1$;}\\ 
...
\begin{theorem}
  ...
  \begin{align}
    ...
    \nonumber \big(\mu_{\cX,\bfr}^{t,t_0}\big)^*(a_{\ell,j;t})&=a^\circ_{\ell,j;t_0}+\sum_{i:k_i=\ell} \frac{\varepsilon_{\bfr,\ell;t_i}}{d_\ell} \int_{\big(\mu_{\cX,\bfr}^{t_i,t_0}\big)^*(y_{\ell;t_i}^{\varepsilon_{\bfr,\ell;t_i}})}^{\big(\mu_{\cX,\bfr}^{t_i,t_0}\big)^*\beta^*(y_{\ell;t_i}^{\varepsilon_{\bfr,\ell;t_i}})} \frac{u^{\varepsilon_{\bfr,\ell;t_i} (r_\ell-j)-1}}{Z_{\ell;t_i}(u^{\varepsilon_{\bfr,\ell;t_i}})}du;
  \end{align}
  where $t_0$ and $t$ are connected through vertices $t_1,\ldots,t_{w-1}$ by mutations in directions $k_1,\ldots,k_w$ and $a^\circ_{\ell,j;t_0}=a_{\ell,j;t_0}$ if there are an even number of $i$ so that $k_i=\ell$ while $a^\circ_{\ell,j;t_0}=a^*_{\ell,j;t_0}$ if there are an odd number of $i$ so that $k_i=\ell$.
\end{theorem}
\begin{proof}
  ...
  \begin{align*}
    \prod_{\ell\ne k} \left(\frac{F_{\bfr,\ell;t}(\hat y_{1;t_0} s_{1;t_0}^{-d_1},\ldots,\hat y_{n;t_0} s_{n;t_0}^{-d_n})}{F_{\bfr,\ell;t}(\hat y_{1;t_0},\ldots,\hat y_{n;t_0})}\right)^{B_{i\ell;t'}/d_\ell}
    \left(\frac{F_{\bfr,k;t'}(\hat y_{1;t_0} s_{1;t_0}^{-d_1},\ldots,\hat y_{n;t_0} s_{n;t_0}^{-d_n})}{F_{\bfr,k;t'}(\hat y_{1;t_0},\ldots,\hat y_{n;t_0})}\right)^{-B_{ik;t}/d_k}.
  \end{align*}
