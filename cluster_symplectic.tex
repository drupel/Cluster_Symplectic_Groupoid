...
In the case of cluster algebras, the quantum $\cA$-varieties \cite{BZ05} and the quantum $\cX$-varieties \cite{FG09c} are both concrete examples of quantization of Poisson manifolds.
...
The construction of $\cG \rra L$ utilizes the construction of local symplectic groupoids by Poisson sprays \cite{CM11, CMS17}.
