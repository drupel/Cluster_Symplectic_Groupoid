...
A symplectic groupoid map from $(\cG_1, \omega_1) \rra M_1$ to $(\cG_2, \omega_2) \rra M_2$ is a Lie groupoid map $\tilde{\varphi}: \cG_1 \to \cG_2$ which is also a symplectomorphism.
