...
The first step will be to have an explicit computation of the Poisson structures on each of these symplectic groupoids.
\begin{lemma}
  \label{le:groupoid Poisson structures}
  \begin{align}
    \pi_{\cG_\cX}&:=\omega_{\cG_\cX}^{-1}=\\
    \pi_{\cD_\cX}&:=\omega_{\cD_\cX}^{-1}=\\
    \pi_{\cG_\cA}&:=\omega_{\cG_\cA}^{-1}=\sum_{i} \frac{\partial}{\partial x_i} \wedge \frac{\partial}{\partial p_i}
			- \left(
			  \sum_{i, j} \Omega_{ij}x_i p_j \frac{\partial}{\partial x_j} \wedge \frac{\partial}{\partial p_i}
...
Write $\kappa_\cX:\cG_\cX\to\cD_\cX$ and $\kappa_\cA:\cG_\cA\to\cD_\cA$ for the covering maps from the source-simply connected symplectic groupoids to the symplectic doubles.
...
\begin{align*}
  \tilde H_\cX^{k,\varepsilon}&=\frac{\varepsilon}{d_k}\Li_2(-y_k^\varepsilon)-\frac{\varepsilon}{d_k}\Li_2(-y_k^\varepsilon)
  \bar H_\cX^{k,\varepsilon}&=\frac{\varepsilon}{d_k}\Li_2(-y_k^\varepsilon)-\frac{\varepsilon}{d_k}\Li_2(-y_k^\varepsilon)
  \tilde H_\cA^{k,\varepsilon}&=\frac{\varepsilon}{d_k}\Li_2(-\hat y_k^\varepsilon)-\frac{\varepsilon}{d_k}\Li_2(-\hat y_k^\varepsilon)
  \bar H_\cA^{k,\varepsilon}&=\frac{\varepsilon}{d_k}\Li_2(-\hat y_k^\varepsilon)-\frac{\varepsilon}{d_k}\Li_2(-\hat y_k^\varepsilon)
\end{align*}
\begin{lemma}

  \begin{align}
    \dot q_\ell&=\{\tilde H_\cX^{k,\varepsilon},q_\ell\}_{\cG_\cX}=\\
    \dot b_\ell&=\{\bar H_\cX^{k,\varepsilon},b_\ell\}_{\cD_\cX}=\\
    \dot p_\ell&=\{\tilde H_\cA^{k,\varepsilon},p_\ell\}_{\cG_\cA}=\\
    \dot a_\ell&=\{\bar H_\cA^{k,\varepsilon},a_\ell\}_{\cD_\cA}=
  \end{align}
\end{lemma}
